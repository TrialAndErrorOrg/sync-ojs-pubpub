...
\\jyear{2023}
\\paperpublished{March 31st, 2023}
\\paperpublisheddate{2023-03-31}
...
describe('findCitations', () => {
  it('should find all citations in a LaTeX document', () => {
    const document = `
        This is a \\parencite[see][p. 123]{smith2000} citation.
        This is a \\textcite{doe2005} citation.
        This is a \\parencites[see][p. 456]{jones2010}[and][p. 789]{smith2000} citation.
        This is a \\textcites{doe2005}[see][p. 123]{jones2010}[and][p. 456]{smith2000} citation.
      `
    const citations = findCitations(document)
  ...
  it('should handle citations with no optional arguments', () => {
    const document = `
        This is a \\parencite{smith2000} citation.
        This is a \\textcite{doe2005} citation.
        This is a \\parencites{jones2010}{smith2000} citation.
        This is a \\textcites{doe2005}{jones2010}{smith2000} citation.
      `
    const citations = findCitations(document)
  ...
  it('should handle citations with one optional argument', () => {
    const document = `
        This is a \\parencite[see]{smith2000} citation.
        This is a \\textcite[see]{doe2005} citation.
        This is a \\parencites{jones2010}[see]{smith2000} citation.
        This is a \\textcites{doe2005}[see]{jones2010}[see]{smith2000} citation.
      `
    const citations = findCitations(document)
